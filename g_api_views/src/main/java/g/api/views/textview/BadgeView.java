...
public class BadgeView extends AppCompatTextView {
     ...
     * @param index   the tab_id of the tab within the target.
     */
    ...
    private void init(Context context, View target, int tabIndex) {
        ...
        badgeRadius = dipToPixels(DEFAULT_CORNER_RADIUS_DIP);
    ...
    public void setBadgeRadius(int radiusInPx) {
        badgeRadius = radiusInPx;
    }
