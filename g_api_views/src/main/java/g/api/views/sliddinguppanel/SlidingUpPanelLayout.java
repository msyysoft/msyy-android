...
//gyy:import com.nineoldandroids.view.animation.AnimatorProxy;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * How far the panel is offset from its expanded tab_id.
    ...
    public interface PanelSlideListener {
        /**
         * Called when a sliding pane's tab_id changes.
         *
         ...
         *
         * @param panel The child view that was slid to an collapsed tab_id
         */
         ...
         *
         * @param panel The child view that was slid to a expanded tab_id
         */
         ...
         *
         * @param panel The child view that was slid to a anchored tab_id
         */
         ...
         *
         * @param panel The child view that was slid to a hidden tab_id
         */
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.sliddinguppanel_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.sliddinguppanel_below_shadow);
            }
        } else {
            mShadowDrawable = null;
        }
     ...
     *
     * @param anchorPoint A value between 0 and 1, determining the tab_id of the anchor point
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (!isTouchEnabled() || mIsScrollableViewHandlingTouch) {
            mDragHelper.cancel();
            return false;
        }
    ...
    /*
     * Computes the top tab_id of the panel based on the slide offset.
     */
    ...
    /*
     * Computes the slide offset based on the top tab_id of the panel
     */
    private float computeSlideOffset(int topPosition) {
        // Compute the panel top tab_id if the panel is collapsed (offset 0)
        final int topBoundCollapsed = computePanelTopPosition(0);

        // Determine the new slide offset based on the collapsed top tab_id and the new required
        // top tab_id
        return (mIsSlidingUp
    ...
    private void applyParallaxForCurrentSlideOffset() {
        if (mParallaxOffset > 0) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                ...
                //gyy:AnimatorProxy.wrap(mMainView).setTranslationY(mainViewOffset);
            }
        }
    }
    ...
    private void onPanelDragged(int newTop) {
        ...
        // Recompute the slide offset based on the new top tab_id
        mSlideOffset = computeSlideOffset(newTop);
        applyParallaxForCurrentSlideOffset();
    ...
    /**
     * Smoothly animate mDraggingPane to the target X tab_id within its range.
     *
     * @param slideOffset tab_id to animate to
