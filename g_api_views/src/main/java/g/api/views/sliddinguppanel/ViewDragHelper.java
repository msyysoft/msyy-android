...
public class ViewDragHelper {
    ...
    /**
     * A view is currently being dragged. The tab_id is currently changing as a result
    ...
    // Last known tab_id/pointer tracking
    ...
    public static abstract class Callback {
        ...
        /**
         * Called when the captured view's tab_id changes as the result of a drag or settle.
         *
         * @param changedView View whose tab_id changed
         * @param left New X coordinate of the left edge of the view
         * @param top New Y coordinate of the top edge of the view
         * @param dx Change in X tab_id from the last call
         * @param dy Change in Y tab_id from the last call
         */
         ...
         *
         * @param index the ordered tab_id to query for
         * @return index of the view that should be ordered at tab_id <code>index</code>
         */
         ...
         * @param dx Proposed change in tab_id for left
         * @return The new clamped tab_id for left
         */
         ...
         * @param dy Proposed change in tab_id for top
         * @return The new clamped tab_id for top
         */
    ...
    /**
     * Animate the view <code>child</code> to the given (left, top) tab_id.
     ...
     * @param finalLeft Final left tab_id of child
     * @param finalTop Final top tab_id of child
    ...
    /**
     * Settle the captured view at the given (left, top) tab_id.
     * The appropriate velocity from prior motion will be taken into account.
     * If this method returns true, the caller should invoke {@link #continueSettling(boolean)}
     * on each subsequent frame to continue the motion until it returns false. If this method
     * returns false there is no further work to do to complete the movement.
     *
     * @param finalLeft Settled left edge tab_id for the captured view
     * @param finalTop Settled top edge tab_id for the captured view
     * @return true if animation should continue through {@link #continueSettling(boolean)} calls
     */
     ...
     * Settle the captured view at the given (left, top) tab_id.
     *
     * @param finalLeft Target left tab_id for the captured view
     * @param finalTop Target top tab_id for the captured view
     ...
     *
     * @param minLeft Minimum X tab_id for the view's left edge
     * @param minTop Minimum Y tab_id for the view's top edge
     * @param maxLeft Maximum X tab_id for the view's left edge
     * @param maxTop Maximum Y tab_id for the view's top edge
     */
     ...
     * @param dx Motion since initial tab_id along X axis
     * @param dy Motion since initial tab_id along Y axis
     ...
     * will return false.
     *
     * @param x X tab_id to test in the parent's coordinate system
     * @param y Y tab_id to test in the parent's coordinate system
