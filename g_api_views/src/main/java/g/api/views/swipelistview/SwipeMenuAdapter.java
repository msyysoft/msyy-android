...
public class SwipeMenuAdapter implements WrapperListAdapter, SwipeMenuView.OnSwipeItemClickListener {
    ...
    private SwipeListViewIFaces.OnMenuItemClickListener onMenuItemClickListener;
    private boolean mUseDifferentSwipeMenu = false;

    public SwipeMenuAdapter(Context context, ListAdapter adapter, boolean useDifferentSwipeMenu) {
        mAdapter = adapter;
        mContext = context;
        mUseDifferentSwipeMenu = useDifferentSwipeMenu;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (mUseDifferentSwipeMenu)
                layout.setSwipeMenuView(menuView);
            layout.closeMenu();
            layout.setPosition(position);
    ...
    public void setOnSwipeItemClickListener(SwipeListViewIFaces.OnMenuItemClickListener onMenuItemClickListener) {
