 ...
 * 
 * <p>
 * This class enables you to calculate the new row tab_id for a card(which was
...
public class PositionCalculator {
	...
	/**
	 * Calculate correct row tab_id after orientation change.
	 * 
	 * @param oldRowPosition
	 *            row tab_id The visible row tab_id in old orientation
	 ...
	 * @return the new row tab_id to be selected after orientation change.
