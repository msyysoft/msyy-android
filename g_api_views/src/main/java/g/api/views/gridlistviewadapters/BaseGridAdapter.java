...
import g.api.views.gridlistviewadapters.dataholders.CardDataHolder;
import g.api.views.gridlistviewadapters.dataholders.CardPositionInfo;
...
import g.api.views.gridlistviewadapters.utils.GridDataStructure;
import g.api.views.gridlistviewadapters.utils.OnLoadMoreRequestListener;
import g.api.views.gridlistviewadapters.utils.ViewHolderPositionTagger;
...
abstract class BaseGridAdapter<E, CVH> extends BaseAdapter {
	...
	/**
	 * Gets the tab_id tagger instance, this class helps us tag our current
	 * card tab_id to views present in user's ViewHolder class in each
	 ...
	 * 
	 * @return the tab_id tagger instance.
	...
	/**
	 * Gets row present at given tab_id which returns instance of
	 ...
	 * 
	 * @param position
	 *            If its a last tab_id & listener is also set then dispatch
	 *            the event.
	 */
	 ...
	 *            the card tab_id info which holds card data type & its
	 *            absolute tab_id.
	 */
	 ...
	 *            to set view values.
	 * @param cardPositionInfo
	 *            the card positional info like its type, absolute-tab_id etc.
	 */
	...
	/**
	 * Gets the card data for given card tab_id.
	 * 
	 * @param absoluteCardPosition
	 *            the absolute card tab_id within grid-structure (in your
	 *            linear structure.)
	 * @return the card data present at given tab_id.
	 */
	...
	/**
	 * Validates if given row tab_id is between data size range or throws
	 * exception.
	 * 
	 * @param position
	 *            the tab_id to be verified.
	 */
	 ...
	 * @param data
	 *            Data for given row tab_id, the data present at given
	 *            tab_id is retrieved by library & passed to your class so
