 ...
 * current card tab_id, when click event occurs this card absolute tab_id
 ...
 * views with card's absolute tab_id if they were registered for click events
 * so that this tab_id can be used to identify when click event happens.
 * </p>
 */
