 ...
 * {@link androidx.core.widget.CursorAdapter} such that it places data
 ...
 * {@link androidx.core.widget.CursorAdapter} since query was performed on
...
public abstract class CursorGridAdapter<CVH> extends
	 ...
	 * 
	 * The query is provided by a {@link FilterQueryProvider}. If
	 ...
	 * provider's
	 * {@link FilterQueryProvider#runQuery(CharSequence)} method
	...
	public Cursor getCardData(int absoluteCardPosition) {
		...
		if (!mCursor.moveToPosition(absoluteCardPosition)) {
			throw new IllegalStateException("couldn't move cursor to tab_id "
