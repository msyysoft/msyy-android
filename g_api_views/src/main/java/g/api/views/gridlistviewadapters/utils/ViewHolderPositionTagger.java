 ...
 * under the License.
 */
package g.api.views.gridlistviewadapters.utils;
...
/**
 * <p>
 * ViewHolderPositionTagger is used to tag tab_id Value to View on each
 * getView call, this class is responsible for scanning Views presents in
 * ViewHolder class & tagging card's absolute tab_id value to all children
...
public class ViewHolderPositionTagger {
	 ...
	 * the view is registered for OnClickEvent then tab_id value will be
	 * tagged to that view, this tab_id will be used to retrieve data present
	 * at row tab_id when click event occurs.
	 * 
	 * @param holder
	 *            the Object in which we need to scan for {@link View} members
	 * @param position
	 *            the row tab_id which needs to be tagged.
	 */
	 ...
	 * tab_id to Views present inside your CustomObjects.
	 * 
	 * @param child
	 *            the child
	 */
	...
	/**
	 * Adds the tab_id tag to a view if its registered for clicking.
	 * 
	 * @param view
	 *            the view instance to be tagged.
	 * @param position
	 *            the row tab_id to be tagged.
	 */
