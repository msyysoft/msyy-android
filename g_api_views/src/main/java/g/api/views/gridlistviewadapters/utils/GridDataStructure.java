 ...
 * 
 * <p>
 * Note: This class only bind the tab_id info of cards , actual card data is
...
public class GridDataStructure {
		...
		if (isFirstChunk == false) {
			...
			if (null != lastRow) {
				...
				if (emptyCardIndex != -1) {
					...
					// new card at index starting from tab_id of empty
					// card in last row.
	...
	private int addNewCard(RowDataHolder gridRow, int absoluteCardposition,
		...
		// tab_id in the grid, this index helps us keep mapping between our
