...
import g.api.views.pull2refreshview.util.PtrCLog;
...
public class PtrFrameLayout extends RelativeLayout {
    ...
    final public boolean dispatchTouchEventSupper(MotionEvent e) {
        return super.dispatchTouchEvent(e);
    }

    @Override
    final public boolean dispatchTouchEvent(MotionEvent e) {
        if (!isEnabled() || mContent == null || mHeaderView == null) {
            return dispatchTouchEventSupper(e);
        }
        int action = e.getAction();
        //#modify by guyiyong
        if (childRequestTouchEvent(e)) {
            switch (action) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                // The cancel event will be sent once the tab_id is moved.
    ...
    private void updatePos(int change) {
        ...
        // leave initiated tab_id or just refresh complete
    ...
    /**
     * The duration to return back to the refresh tab_id
     *
     * @param duration
     */
    ...
    private void sendCancelEvent() {
        ...
        // The ScrollChecker will update tab_id and lead to send cancel event when mLastMoveEvent is null.
        // fix #104, #80, #92
    ...
    //重新将内容视图和头部视图拿到顶部
    public void bringToFrontMyOwnChild() {
        if (mContent != null)
