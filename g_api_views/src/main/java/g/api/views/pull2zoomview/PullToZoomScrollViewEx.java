package g.api.views.pull2zoomview;
 ...
 */
public class PullToZoomScrollViewEx extends PullToZoomBase<XScrollView> {
    ...
    private XScrollView.OnScrollListener onScrollListener;
    ...
    public PullToZoomScrollViewEx(Context context, AttributeSet attrs) {
        ...
        ((XScrollView) mRootView).setOnScrollListener(new XScrollView.OnScrollListener() {
            @Override
            public void onScrollChanged(int left, int top, int oldLeft, int oldTop) {
                if (isPullToZoomEnabled() && isParallax()) {
                    ...
                    if (onScrollListener != null) {
                        onScrollListener.onScrollChanged(left, top, oldLeft, oldTop);
                    }
                }
            }
        });
    ...
    @Override
    protected XScrollView createRootView(Context context, AttributeSet attrs) {
        XScrollView scrollView = new XScrollView(context, attrs);
    ...
    @Override
    final public XScrollView getRootView() {
        return mRootView;
    }
}
