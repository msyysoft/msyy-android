 ...
 * Time: 12:31 PM
 */
public class DynamicGridView extends AddGridView {
    ...
    private DynamicGridViewIFaces.OnDropListener mDropListener;
    private DynamicGridViewIFaces.OnDragListener mDragListener;
    private DynamicGridViewIFaces.OnEditModeChangeListener mEditModeChangeListener;
    ...
    private DynamicGridViewIFaces.OnSelectedItemBitmapCreationListener mSelectedItemBitmapCreationListener;
    ...
    public void setOnDropListener(DynamicGridViewIFaces.OnDropListener dropListener) {
        this.mDropListener = dropListener;
    }

    public void setOnDragListener(DynamicGridViewIFaces.OnDragListener dragListener) {
    ...
    public void setOnEditModeChangeListener(DynamicGridViewIFaces.OnEditModeChangeListener editModeChangeListener) {
    ...
    public void setOnSelectedItemBitmapCreationListener(DynamicGridViewIFaces.OnSelectedItemBitmapCreationListener selectedItemBitmapCreationListener) {
    ...
    private void handleCellSwitch() {
        ...
        if (targetView != null) {
            ...
            DynamicGridViewIFaces.SwitchCellAnimator switchCellAnimator;
    ...
    private class PreHoneycombCellAnimator implements DynamicGridViewIFaces.SwitchCellAnimator {
        private int mDeltaY;
        private int mDeltaX;
    ...
    private class KitKatSwitchCellAnimator implements DynamicGridViewIFaces.SwitchCellAnimator {
    ...
    private class LSwitchCellAnimator implements DynamicGridViewIFaces.SwitchCellAnimator {
