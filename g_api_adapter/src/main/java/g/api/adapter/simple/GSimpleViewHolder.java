 ...
 *
 * @param <MyAdapterData> the generic type of the data in each item
 * @author http://www.liaohuqiu.net
 */
public abstract class GSimpleViewHolder<MyAdapterData> {
    ...
    public View createView(LayoutInflater inflater, GSimpleAdapter adapter) {
     ...
     */
    public abstract void showData(int position, GSimpleAdapter<MyAdapterData> adapter);
