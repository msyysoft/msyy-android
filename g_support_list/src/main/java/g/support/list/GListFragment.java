...
public abstract class GListFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    final protected void setupListView(View rootView) {
        lv_list = (MyPTRFatherListView) rootView.findViewById(R.id.lv_list);
