...
import g.api.http.volley.Cache;
import g.api.http.volley.Network;
import g.api.http.volley.NetworkError;
import g.api.http.volley.NetworkResponse;
import g.api.http.volley.NoConnectionError;
import g.api.http.volley.Request;
import g.api.http.volley.ResponseDelivery;
import g.api.http.volley.RetryPolicy;
import g.api.http.volley.ServerError;
import g.api.http.volley.TimeoutError;
...
import g.api.http.volley.http.impl.cookie.DateUtils;
...
public class BasicNetwork implements Network {
    ...
    protected boolean allowAllSC = false;
    ...
    public void setAllowAllSC(boolean allowAllSC) {
        this.allowAllSC = allowAllSC;
    }
    ...
    public NetworkResponse performRequest(Request<?> request, ResponseDelivery delivery) throws VolleyError {
        ...
        while (true) {
            ...
            try {
                ...
                httpResponse = mHttpStack.performRequest(request, delivery, headers);
                ...
                // only http code 200 is allowed by default
                if (!allowAllSC) {
