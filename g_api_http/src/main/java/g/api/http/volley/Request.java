...
import g.api.http.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     * <p/>
     * <p>Note that you can directly override {@link #getBody(HttpURLConnection connection)} for custom data.</p>
     *
     * @throws AuthFailureError in the event of auth failure
     */
    ...
    /**
     * Subclasses could implement this to perform delivery of the parsed
     * progress to their listeners.
     */
